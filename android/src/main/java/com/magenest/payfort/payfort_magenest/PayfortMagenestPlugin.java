...
/** PayfortMagenestPlugin */
public class PayfortMagenestPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "payfort_magenest");
...
//    registrar.addActivityResultListener(delegate);
  ...
  public static void registerWith(Registrar registrar) {
    ...
    Log.w("Call", "register ===========================");
    PayfortMagenestPlugin plugin = new PayfortMagenestPlugin();
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "payfort_magenest");
  ...
  private void setupEngine(BinaryMessenger messenger) {
    MethodChannel channel = new MethodChannel(messenger, "payfort_magenest");
    channel.setMethodCallHandler(this);
  }
